...
import com.shuzhi.opencv.ui.theme.harmonizeWithPrimary
import com.shuzhi.opencv.ui.theme.util.provider.LocalScreenSize
...
suspend fun ToastHostState.showFailureToast(
    ...
    message = context.getString(R.string.smth_went_wrong),
    icon = Icons.Rounded.ErrorOutline,
    duration = ToastDuration.Long
)

suspend fun ToastHostState.showSuccessToast(
    context: Context,
) = showToast(
...
fun showAndroidToast(msg:String){
